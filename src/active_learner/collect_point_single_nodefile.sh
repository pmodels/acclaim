#!/bin/bash
#./scripts/run_test_single_alg.sh $(TEST) $(PATH_TO_TESTS) $(ALG) $(NODE_STRING) $(PPN_STRING) $(MSG_SIZE_STRING) $(NODEFILE_PATH)

# Runs a single OSU Benchmark for a single algorithm with a specific nodefile, returns the data
# $1 = name of test
# $2 = algorithm name
# $3 = number of nodes
# $4 = number of ppn
